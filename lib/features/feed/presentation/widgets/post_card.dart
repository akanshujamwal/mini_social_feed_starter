...
//                   child: CircleAvatar(backgroundImage: NetworkImage(post.userAvatarUrl)),
//                 ),
...
//         // no-op for now; the Feed list will read from Hive on next build in a full app
//       },
//       builder: (context, state) {
//         final icon = post.isLiked ? Icons.favorite : Icons.favorite_border;
//         return InkWell(
//           onTap: () => context.read<PostInteractionBloc>().add(PostLikeToggled(post.id)),
//           child: Row(
//             children: [
//               Icon(icon),
