...
//     // jsonplaceholder doesn't have true pagination for /posts, we simulate with _start/_limit
//     final start = (page - 1) * limit;
//     final postsRes = await _dio.get('/posts', queryParameters: {'_start': start, '_limit': limit});
//     final usersRes = await _dio.get('/users');
//     final users = { for (final u in (usersRes.data as List)) u['id'] as int : u as Map<String, dynamic> };

//     final models = <PostModel>[];
//     for (final p in (postsRes.data as List)) {
//       final user = users[(p['userId'] as int)]!;
//       models.add(PostModel.fromJsonPlaceholder(p as Map<String, dynamic>, user));
//     }
//     return models;
//   }
// }
